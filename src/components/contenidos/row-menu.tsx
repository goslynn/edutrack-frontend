...
import type { RowState } from "@/types/contenidos"
 ...
 * deja interactivo. Si no queda ningún ítem visible, no se renderiza nada.
 */
    ...
    <div className="relative inline-flex">
      ...
      {open && (
        <>
          ...
          <div
            role="menu"
            className="absolute top-9 right-0 z-[31] min-w-[190px] rounded-lg border border-border bg-background p-1.5 shadow-lg"
          >
            {visible.map((it, i) => {
              const Icon = it.icon
