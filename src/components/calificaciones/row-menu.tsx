...
import type { RowState } from "@/types/calificaciones"
...
/**
 * Kebab de acciones de fila. El estado RBAC de cada ítem es la única expresión de
 * permisos: `hidden` lo omite, `disabled` lo atenúa e inerte, `enabled` lo deja
 * interactivo.
 */
